...
function tapLove(id) {
  ...
  if (loveTaps.size === 4) {
    Swal.fire({
      ...
      typeWriterEffect(
        `Chúc ${userName} của anh 1/6 thật vui vẻ như một đứa trẻ, nhưng được anh thương như một nữ hoàng 👑. Dù em có lớn bao nhiêu thì trong tim anh, em vẫn là cô nàng bé bỏng cần được cưng chiều mỗi ngày! 🫰💘`,
        'loveMsg',
        () => {
